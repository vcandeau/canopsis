...
Ext.define('canopsis.view.Dashboard.PortalPanel', {
    ...
    initEvents : function(){
        ...
        this.dd = Ext.create('canopsis.view.Dashboard.PortalDropZone', this, this.dropConfig);
    },
    ...
    beforeDestroy : function() {
        ...
        canopsis.view.Dashboard.PortalPanel.superclass.beforeDestroy.call(this);
    }
});
